...
scrollen durch sie und die $\sigma_x$-Verteilung darunter. Außer den Schnittgrößen und
...
ist; diese Kanten sind mit \code{R} gekennzeichnet und tragen dieselben Werte $\sigma$ und $	au$.
Gezeichnet wird so, wie ihr es von Hand macht: Zug zeigt immer von der Scheibe weg, auf beiden
