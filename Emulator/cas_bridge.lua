...
_G.getXWerte = function() return X_Werte end
_G.applyKGVZustand = applyKGVZustand
_G.exportKGVToTI = exportKGVToTI
_G.exportLGSMatrixToTI = exportLGSMatrixToTI
_G.getLGS = function() return lgs_equations end
_G.getTeilsysteme = function() return glob_ts_scheibe, glob_disk_centers, glob_num_disks end
_G.getPolplan = function() return polplan end
